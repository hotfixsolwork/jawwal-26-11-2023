...
<div class="h-100 bg-cover lightblue bg-center py-5 d-flex align-items-center">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-xl-4 mx-auto">
                <div class="card text-left">
                    <div class="card-body">
                        ...
                        <!-- <div class="mt-3">
                            {{translate('We have Not an account')}} ? <a href="{{route('register')}}" class="btn-link mar-rgt text-bold">{{translate('register')}}</a>
                        </div> -->
                        <!--@if (env("DEMO_MODE") == "On")
                            <div class="mt-4">
