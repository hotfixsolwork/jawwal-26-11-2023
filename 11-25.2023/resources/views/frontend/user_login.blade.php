                                    ...
                                    <div class="pt-3 pt-lg-4">
                                        <div class="">
                                            <form class="form-default" role="form" action="{{ route('login') }}" method="POST">
                                                <input type="hidden" value="{{request('type')}}" name="login_type" />
                                                @csrf
                                                <!-- Email or Phone -->
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="password" class="form-control rounded-0 {{ $errors->has('password') ? 'is-invalid' : '' }}" placeholder="{{ translate('Password') }}" name="password" id="password" aria-describedby="passwordToggle">
...
@section('script')
    ...
    // Add a click event listener to the eye icon button
