...
<header class="@if(get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 ">
    ...
    <div class="position-relative logo-bar-area border-bottom border-md-nonea z-1025 bg-primary">
        ...
        <div class="container">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ml-xl-4 w-20 overflow-hidden">
                ...
                <div class="ml-auto mr-0">
                    ...
                    @else
                        ...
                        <span class="d-none d-xl-flex align-items-center nav-user-info ml-3">
                            ...
                            <!--<span class="size-40px rounded-circle overflow-hidden border d-flex align-items-center justify-content-center bg-white">
                            ...
                            <a href="{{ route('user.login', ['type' => 'seller']) }}" class="text-white fs-12 d-inline-block border-right border-soft-light border-width-2 pr-2 ml-3">{{ translate('Login to Seller')}}</a>

                            <a href="{{ route('seller.registration') }}" class="text-white fs-12 d-inline-block py-2 pl-2 pr-2  border-soft-light">{{ translate('Become a Seller')}}</a>
            ...
            <div class="d-flex h-100">
                        ...
                        <form action="{{ route('search') }}" method="GET" class="stop-propagation">
                            ...
                            <div class="d-flex position-relative align-items-center">
                                ...
                                <div class="search-input-box">
                                    ...
                                    <input type="text" class="border border-soft-light form-control fs-14 hov-animate-outline" id="search" style="border-radius:0px;" name="keyword" @isset($query)

                                        value="{{ $query }}"

                                    @endisset placeholder="{{translate('')}}" autocomplete="off">
                ...
                <div class="ml-auto mr-0">
                    ...
                    @auth
                        ...
                        <span class="d-none d-xl-flex align-items-center nav-user-info py-0px @if(isAdmin()) ml-5 @endif" id="nav-user-info">
                    ...
                    @else
                        ...
                        <span class="d-none d-xl-flex align-items-center nav-user-info ml-3 mt-1">
                            ...
                            <!-- <a href="{{ route('user.login', ['type' => 'seller']) }}" class="text-reset opacity-60 hov-opacity-100 hov-text-primary fs-12 d-inline-block border-right border-soft-light border-width-2 pr-2 ml-3">{{ translate('Login to Seller')}}</a> -->

                            <!-- <a href="{{ route('seller.registration') }}" class="text-reset opacity-60 hov-opacity-100 hov-text-primary fs-12 d-inline-block py-2 pl-2 pr-2  border-soft-light">{{ translate('Become a Seller')}}</a> -->
