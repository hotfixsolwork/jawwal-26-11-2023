<div class="text-left">
    ...
    <div class="row align-items-center">
        ...
        <!--<div class="col-xl-4 col-lg-4 col-md-3 col-sm-4 mb-3">
    ...
    <div class="d-flex flex-wrap align-items-center">
        <div class="d-flex align-items-center mr-4 mb-4">
            ...
            <span class="text-secondary fs-14 fw-400 mr-4 w-50px">{{ translate('Sold by') }}</span>
                <a href=""
                    class="text-reset hov-text-primary fs-14 fw-700">{{ translate('Ahmad') }}</a>
            
        </div>
        <!-- Messase to seller -->
        <!--@if (get_setting('conversation_system') == 1)
            <div class="">
                <button class="btn btn-sm btn-soft-primary btn-outline-primary hov-svg-white hov-text-white rounded-4"
...
@endif
    ...
    @if ($detailedProduct->auction_product != 1)
        <form id="option-choice-form">
            ...
            <input type="hidden" name="seller_id" value="{{request()->query('seller')}}">
            ...
            @if ($detailedProduct->digital == 0)
                ...
                @if ($detailedProduct->rams)
                    <div class="row no-gutters mb-3">
                        <div class="col-sm-2">
                            <div class="text-secondary fs-14 fw-400">{{ translate('Ram') }}</div>
                        </div>
                        <div class="col-sm-10">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="aiz-radio-inline">
                                    ...
                                    @foreach (explode(',', $detailedProduct->rams) as $key => $ram)
                                        <label class="aiz-megabox pl-0 mr-2 mb-0" data-toggle="tooltip"
                                            data-title="{{ $ram }}">
                                            <input type="radio" name="ram" value="{{ $ram }}"
                                                @if ($key == 0) checked @endif>
                                            <span
                                                class="aiz-megabox-elem rounded-0 d-flex align-items-center justify-content-center p-2">
                                                {{ $ram }}
                                            </span>
                                        </label>
                                    @endforeach
                ...
                @if ($detailedProduct->storage)
                    <div class="row no-gutters mb-3">
                        <div class="col-sm-2">
                            <div class="text-secondary fs-14 fw-400">{{ translate('Storage') }}</div>
                        </div>
                        <div class="col-sm-10">
                            <div class="d-flex align-items-center">
                                <div class="aiz-radio-inline">
                                    @foreach (explode(',',$detailedProduct->storage) as $key => $store)
                                        <label class="aiz-megabox pl-0 mr-2 mb-0" data-toggle="tooltip"
                                            data-title="{{ $store }}">
                                            <input type="radio" name="storage" value="{{ $store }}"
                                                @if ($key == 0) checked @endif>
                                            <span
                                                class="aiz-megabox-elem rounded-0 d-flex align-items-center justify-content-center p-2">
                                                {{ $store }}
                ...
                @endif
                    ...
                    <div class="row no-gutters mb-3">
                        <div class="col-sm-2">
                            <div class="text-secondary fs-14 fw-400">{{ translate('Version') }}</div>
                        </div>
                        <div class="col-sm-10">
                            <div class="d-flex align-items-center">
                                <div class="aiz-radio-inline">
                                        ...
                                        <label class="aiz-megabox pl-0 mr-2 mb-0" data-toggle="tooltip"
                                            data-title="">
                                            <input type="radio" name="storage" value="USA Version"
                                                >
                                            <span
                                                class="aiz-megabox-elem rounded-0 d-flex align-items-center justify-content-center p-2">
                                               USA Version
                           ...
                           <div class="aiz-radio-inline">
                                   ...
                                   <label class="aiz-megabox pl-0 mr-2 mb-0" data-toggle="tooltip"
                                       data-title="">
                                       <input type="radio" name="storage" value="UAE Version"
                                           >
                                       <span
                                           class="aiz-megabox-elem rounded-0 d-flex align-items-center justify-content-center p-2">
    ...
    @if ($detailedProduct->auction_product)
        ...
        @if ($detailedProduct->auction_end_date >= strtotime('now'))
            <div class="mt-4">
                ...
                @else
                    <button type="button" class="btn btn-primary buy-now  fw-600 w-150px rounded-0"
                        onclick="bid_modal()">
    ...
    @else
        ...
        <div class="mt-3">
            @if ($detailedProduct->digital == 0)
                ...
                @else
                    <button type="button"
                        class="btn btn-warning mr-2 add-to-cart fw-600 w-150px rounded-0 text-white"
                        onclick="addToCart()">
                        <i class="las la-shopping-bag"></i>
                        <span class="d-none d-md-inline-block"> {{ translate('Add to cart') }}</span>
                    </button>
                    <button type="button" class="btn btn-primary buy-now fw-600 add-to-cart w-150px rounded-0"
                        onclick="buyNow()">
