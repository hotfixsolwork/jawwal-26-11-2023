        ...
        <div class="card-body">
            <table class="table aiz-table mb-0">
                ...
                <tr>
                    ...
                    <th data-breakpoints="lg">{{ translate('Bank Account Name') }}</th>
                    <th data-breakpoints="lg">{{ translate('Bank Account Number') }}</th>
                    <th data-breakpoints="lg">{{ translate('Bank Certificate') }}</th>
                    <th data-breakpoints="lg">{{ translate('Vat Proof') }}</th>
                    <th data-breakpoints="lg">{{ translate('Licence Image') }}</th>
                ...
                @foreach($shops as $key => $shop)
                    <tr>
                        ...
                        <td>
                            @if(!empty($shop->bank_certificate_pdf))
                            <a href="{{asset('public/uploads/bank_certificate_pdf/'.$shop->bank_certificate_pdf)}}" target="_blank">View</a>
                            @else
                            N/A
                            @endif
                        </td>
                        <td>
                            @if(!empty($shop->vat_proof))
                            <a href="{{asset('public/uploads/vat_proofs/'.$shop->vat_proof)}}" target="_blank">View</a></td>
                            @else
                            N/A
                            @endif
                        </td>
                        ...
                        <td>
                            @if(!empty($shop->licence_scan_img))
                            <a href="{{asset('public/uploads/licence_scans/'.$shop->licence_scan_img)}}" target="_blank">View</a></td>
                            @else
                            N/A
                            @endif
                        </td>
